...
export class SlideshowComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  private bindClick(arr, time = 400) {
  ...
  private moveContainerWithEdgeSlide(itemToMove: HTMLElement, translatePostion: number, animation?): void {
  ...
  private moveEdgeSlides(changeSlidesPos: number, edgeSlide: HTMLElement, translatePostion: number): void {
  ...
  private moveSlider(translatePostion: number): void {
